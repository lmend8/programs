...
public class Circle1Test
{
   ...
   private Circle4 circle4;
   private Circle5 circle5;
...
public void setup()
{
   ...
   circle2 = new Circle2(0,0,1);
   circel3 = new Circle3(0,2,1);
   circel4 = new Circle3(0,0,4);
   circel5 = new Circle3(0,2,3);
}
...
public void Intersect()
{
	...
	p.intersects(p2);
	Assert.assertTrue(p.intersects(p2));
}
